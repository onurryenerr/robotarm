...
minLineLen = 6; % min length of line to record
minBlackToBegin = 4; %min # of blacks to begin line
...
for i = (3*penTip+2):penTipDouble:(width-(3*penTip+1)) %ignore borders, traverse
    for j = (3*penTip+2):penTipDouble:(height-(3*penTip+1))
